...
export default {
  server: {
    ...
    uriAPI: `${import.meta.env.BUDGETA_SDK_API_PROTOCOL || 'http'}://${import.meta.env.BUDGETA_SDK_API_HOST || 'localhost'}${import.meta.env.BUDGETA_SDK_API_PORT ? (import.meta.env.BUDGETA_SDK_API_PORT !== '443' ? `:${import.meta.env.BUDGETA_SDK_API_PORT}` : '') : ':8080'}/api/`,
